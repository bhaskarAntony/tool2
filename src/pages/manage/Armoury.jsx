...
const viewDetails = (id) =>{
                ...
                <td className="text-center">
                  <Dropdown>
                    ...
                    <Dropdown.Menu>
                      ...
                      <Dropdown.Item onClick={()=>viewDetails(item._id)}>View Details</Dropdown.Item>
  ...
  <Offcanvas show={showCanvas} onHide={closeCanvasHanlder} placement='bottom'>
    ...
    <Offcanvas.Body>
        {
            AddType=='armoury'?(<NewArmoury C_type={'armoury'}/>):AddType=='edit'?(<Edit id={updateId}/>):AddType=='view'?(<WeaponDetails id={updateId}/>):(null)
        }
    </Offcanvas.Body>
  </Offcanvas>
</section>
